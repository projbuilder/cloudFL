              ...
              {enrolledCourses.map((enrolled) => (
                <div key={enrolled.course.id} className="glass-card rounded-xl overflow-hidden hover:shadow-glow transition-all">
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      to={`/dashboard/student/course/${enrolled.course.id}`}
                      className="w-full py-2 bg-fl-primary text-white rounded-lg hover:bg-fl-primary/90 transition-colors flex items-center justify-center"
                    >
                      Continue Learning →
                    </Link>
                  </div>
